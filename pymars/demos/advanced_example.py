...
def advanced_example():
    ...
    try:
        ...
        plt.savefig('advanced_example_partial_dependence.png', dpi=150, bbox_inches='tight')
        plt.close()
        print("Partial dependence plots saved to 'advanced_example_partial_dependence.png'")
        ...
        print(f"  Number of basis functions: {explanation['model_summary']['n_basis_functions']}")

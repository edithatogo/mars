...
| Julia `MarsEarth` | Register new Julia package; keep `MarsRuntime` as superseded legacy package | Release checklist and maintainer notes | MarsRuntime Julia General PR merged on 2026-05-07 (JuliaRegistries/General#154675); MarsEarth has no separate registration PR yet |

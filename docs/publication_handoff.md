...
| npm `mars-earth` | Automation token or trusted-publishing equivalent and scope owner confirmation | `NPM_TOKEN` or npm trusted publishing | Waiting on secret setup |

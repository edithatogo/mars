...
| crates.io `pymars-runtime` | Maintainer-owned namespace; registry token not verified in this inventory | Confirm crate owner and registry token | Owner confirmed | 2026-04-29 |
| npm `@mars-earth/runtime` | Maintainer-owned scope; publish token not verified in this inventory | Confirm npm org and publish token | Owner confirmed | 2026-04-29 |
| NuGet `MarsRuntime` | Maintainer-owned package ID; API key not verified in this inventory | Confirm package ID ownership and API key | Owner confirmed | 2026-04-29 |

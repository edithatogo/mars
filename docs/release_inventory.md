...
| npm `mars-earth` | Maintainer-owned package name; publish token verified for registry auth and GitHub Actions secret wiring reported complete by maintainer | Confirm npm org and GitHub Actions secret wiring | Confirmed | 2026-05-03 |
...
| npm `mars-earth` | Not registered | [npm package page](https://www.npmjs.com/package/mars-earth) | Publish is technically ready; first release can proceed with the configured token secret |

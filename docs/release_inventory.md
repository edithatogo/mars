...
| npm `mars-earth` | Not registered | [npm package page](https://www.npmjs.com/package/mars-earth) | Publish still needs an automation token; current granular token hits `EOTP` |

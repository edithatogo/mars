---
title: "mars / earth repo gap matrix"
description: "This note compares the current repository against the upstream mars / earth references for the comparison slice owned by the parity audit track."
sidebar:
  order: 30
---

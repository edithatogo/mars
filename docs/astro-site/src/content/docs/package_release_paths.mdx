---
title: "Package Release Paths"
description: "This page documents the package-manager-specific release paths for the current binding surface."
sidebar:
  order: 16
---
...
canonical package matrix lives in [Release Inventory](release_inventory)
...
[HPC Contracts](hpc_contracts). Spack, EasyBuild, and conda-forge submissions

---
title: "Parity Audit Gap Classification"
description: "This note classifies the current repo gap matrix using the parity-audit rubric and the matrices already recorded in docs/."
sidebar:
  order: 23
---

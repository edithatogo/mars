---
title: "Starlight Docs Stack Governance"
description: "This page now records the governance state of the adopted Starlight documentation stack."
sidebar:
  order: 43
---
...
- **`starlight-polyglot` `^0.1.0`** — Plugin for generating API docs from Python
  (`pymars`) and TypeScript (`bindings/typescript`) source code

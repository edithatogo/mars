---
title: "Training Core Migration"
description: "Migration from Python orchestration to Rust core for training"
sidebar:
  order: 11
---
...
See [Training Orchestration Inventory](training_orchestration_inventory) for

---
title: "CI and Quality Policy"
description: "This repo enforces a conservative quality gate with Python tests, Ruff, Vale prose lint, mkdocs strict, and Rust core hygiene checks."
sidebar:
  order: 5
---
...
- Rust core observability and profiling guidance as documented in
  [Rust Core Observability and Profiling](rust_core_observability), with
...
See [Supply Chain Security](supply_chain) for provenance and release
automation policy.

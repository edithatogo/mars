---
title: "Parity Audit Packaging and Docs Summary"
description: "This note records the packaging and release conventions that matter for the py-earth / earth parity audit slice, with an emphasis on what this repository does intentionally differently."
sidebar:
  order: 25
---
...
- [docs/package_release_paths](package_release_paths)
- [docs/release_inventory](release_inventory)
- [docs/release_checklist](release_checklist)
- [docs/publication_handoff](publication_handoff)
- [docs/parity_audit_evidence](parity_audit_evidence)
- [docs/parity_audit_feature_matrix](parity_audit_feature_matrix)
- [docs/parity_audit_r_earth_matrix](parity_audit_r_earth_matrix)
- [docs/parity_audit_repo_gap_matrix](parity_audit_repo_gap_matrix)

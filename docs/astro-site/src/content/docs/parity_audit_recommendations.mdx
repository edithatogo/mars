---
title: "Parity Audit Recommendations"
description: "This memo turns the py-earth feature matrix and the mars / earth repo gap matrix into a Rust-first roadmap summary."
sidebar:
  order: 29
---
...
[Parity Audit Gap Classification](parity_audit_gap_classification) so the
...
- [Parity Audit Rubric](parity_audit_rubric)

---
title: "Rust Migration and ABI Compatibility"
description: "This page defines the non-breaking migration posture for future Rust-first work."
sidebar:
  order: 40
---
...
- Binding ABI contract: [Binding ABI and API Contract](binding_abi_contract)
- Rust ownership boundary: [Rust Core Ownership Boundary](rust_core_ownership)
- Rust full conversion boundary: [Rust Core Full Conversion Boundary](rust_core_full_conversion_boundary)

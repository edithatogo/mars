---
title: "Binding ABI and API Contract"
description: "This contract defines the narrow shared boundary for the language bindings."
sidebar:
  order: 2
---
...
See [Binding ABI and Arrow Decision](binding_abi_arrow_decision) for the

...
| R | Package-review packet | R package is published on CRAN as `marsearth` | keep `R CMD check`, manual, vignette, examples, and maintainer notes current for CRAN follow-up and any r-universe mirror |
...
R should be treated as a published CRAN package with ongoing package-review
...
- R: ongoing CRAN maintenance/review follow-up

...
\label{sec:real-data-example-with-pima-indians-diabetes-dataset}
...
# Fit the model
mars_reg.fit(X_train.values, y_train)

# Model evaluation
train_r2 = mars_reg.score(X_train.values, y_train)
test_r2 = mars_reg.score(X_test.values, y_test)
...
\label{sec:analysis-and-interpretation}
...
\label{sec:planned-implementation-of-jaxxla-backend}

...
\section{Computational Performance and Scalability}\label{computational-performance-and-scalability}
...
\section{Comparison with Alternative Methods}\label{sec:comparison-with-alternative-methods}
...
\section{Limitations and Considerations}\label{sec:limitations-and-considerations}

While pymars provides significant advantages for health economic analysis, several limitations should be considered:

\subsection{Computational Considerations}\label{sec:computational-considerations}
...
\subsection{Statistical Considerations}\label{sec:statistical-considerations}

...
\item \textbf{Candidate Generation}: For each existing basis function, generates potential new basis functions by adding hinge or linear terms for each unused variable
...
\section{Comparison with Alternative Methods}\label{comparison-with-alternative-methods}
...
\section{Limitations and Considerations}\label{limitations-and-considerations}
...
\subsection{Statistical Considerations}\label{statistical-considerations}

...
\Plaintitle{pymars: A Pure Python Implementation of Multivariate Adaptive Regression Splines with Applications in Health Economics}
...
\subsection{Key Implementation Features}\label{key-features}
...
\subsection{Real Data Example with Pima Indians Diabetes Dataset}\label{real-data-example-with-pima-indians-diabetes-dataset}
